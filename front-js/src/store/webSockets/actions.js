...
export const webSocketConnectionClosed = error => ({ type: WEB_SOCKET_CONNECTION_CLOSED, error })
export const webSocketConnectionOpened = () => ({ type: WEB_SOCKET_CONNECTION_OPENED })
